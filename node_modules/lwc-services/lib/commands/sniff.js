...
class Sniff extends command_1.Command {
    async run() {
        ...
        let jestFinalConfig = Object.assign({}, jestDefaultConfig, jestConfig_1.jestConfig);
        fs.writeFileSync(path.join(flags.directory, 'jest.config.js'), 'module.exports = ' + util.inspect(jestFinalConfig, inspectOptions));
